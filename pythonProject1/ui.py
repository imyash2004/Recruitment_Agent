...
def display_header():
    ...
    try:
        with open("yash.jpg", "rb") as img_file:
            logo_base64 = base64.b64encode(img_file.read()).decode()
            logo_html = f'<img src="data:image/jpeg;base64,{logo_base64}" alt="Yash Logo" class="logo-image" style="max-height: 100px;">'
    except:
...
def role_selection_section(role_requirements):
    ...
    if not upload_jd:
        ...
        st.markdown(f"<p>Cutoff Score for selection: <b>{40}/100</b></p>", unsafe_allow_html=True)
    
    st.markdown('</div>', unsafe_allow_html=True)

    return role, custom_jd, upload_jd
...
def display_analysis_results(analysis_result):
    ...
    st.markdown(
        '<div style="text-align: right; font-size: 0.8rem; color: #888; margin-bottom: 10px;">Powered by Yash Recruitment</div>',
        unsafe_allow_html=True
    )
    ...
    with col2:
        report_content = f"""
# Yash Recruitment - Resume Analysis Report
...
"""
        ...
        report_content += "\n---\nAnalysis provided by Yash Recruitment Agent"
        
        report_b64 = base64.b64encode(report_content.encode()).decode()
        href = f'<a class="download-btn" href="data:text/plain;base64,{report_b64}" download="yash_resume_analysis.txt">📊 Download Analysis Report</a>'
    ...
    if st.button("Generate Interview Questions"):
        if generate_questions_func:
            with st.spinner("Generating personalized interview questions..."):
                ...
                download_content = f"# Yash Recruitment - Interview Questions\n\n"
                ...
                # Add Yash branding to download content
                download_content += "\n---\nQuestions generated by Yash Recruitment Agent"
                ...
                if questions:
                    ...
                    href = f'<a class="download-btn" href="data:text/markdown;base64,{b64}" download="yash_interview_questions.md">📝 Download All Questions</a>'
                    st.markdown(href, unsafe_allow_html=True)
    ...
    if st.button("Generate Resume Improvements"):
        if improve_resume_func:
            with st.spinner("Analyzing and generating improvements..."):
                ...
                # Create content for download
                download_content = f"# Yash Recruitment - Resume Improvement Suggestions\n\nTarget Role: {target_role if target_role else 'Not specified'}\n\n"
                ...
                # Add Yash branding to download content
                download_content += "\n---\nProvided by Yash Recruitment Agent"
                
                # Add download button
                st.markdown("---")
                report_bytes = download_content.encode()
                b64 = base64.b64encode(report_bytes).decode()
                href = f'<a class="download-btn" href="data:text/markdown;base64,{b64}" download="yash_resume_improvements.md">📝 Download All Suggestions</a>'
                st.markdown(href, unsafe_allow_html=True)
        ...
        if get_improved_resume_func:
            with st.spinner("Creating improved resume..."):
                ...
                with col1:
                    ...
                    href = f'<a class="download-btn" href="data:file/txt;base64,{b64}" download="yash_improved_resume.txt">📄 Download as TXT</a>'
                    st.markdown(href, unsafe_allow_html=True)
...
---
Resume enhanced by Yash Recruitment Agent
"""
                    md_bytes = md_content.encode()
                    md_b64 = base64.b64encode(md_bytes).decode()
                    md_href = f'<a class="download-btn" href="data:text/markdown;base64,{md_b64}" download="yash_improved_resume.md">📝 Download as Markdown</a>'
